...
getKey :: String -> (Map.Map String Value) -> (Map.Map String Value, Value)
...
incrKey :: String -> (Map.Map String Value) -> (Map.Map String Value, Value)
...
handleInput :: String -> TVar (Map.Map String Value) -> STM Value
